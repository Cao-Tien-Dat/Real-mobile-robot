...
class OdometryPublisher(Node):
    def __init__(self):
        ...
        # Serial
        self.ser = serial.Serial('/dev/esp', 115200, timeout=0.01) #100hz
        ...
        # Timers
        self.create_timer(0.01, self.encoder_update)       # 100 Hz
        self.create_timer(0.01, self.publish_odometry)     # 100 Hz
    ...
    def cmd_vel_callback(self, msg):
        ...
        tick_l = int(v_l * self.ticks_per_meter * 0.01) 
        tick_r = int(v_r * self.ticks_per_meter * 0.01)
